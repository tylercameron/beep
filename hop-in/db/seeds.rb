...
car1 = Vehicle.create(vehicle_year: 2016, vehicle_make: 'Honda', vehicle_model: 'Civic', seats: 5, street_address: '3 Oxford St', city: 'Toronto', province: 'ON', postal_code: 'M2V', owner_id: 1)
...
reso1 = Reservation.create(passenger_id: 2, vehicle_id: 1, start_time: 1200, start_location: '220 King St', date: '20161212', destination: 'New York', seats: 2)
