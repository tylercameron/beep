...
Vehicle.create(vehicle_year: 2020, vehicle_make: 'Google', vehicle_model: 'Car', seats: 5, street_address: '259 Queens Quay W', city: 'Toronto', province: 'ON', postal_code: 'M5J 2N5', owner_id: 3)
...
Vehicle.create(vehicle_year: 2020, vehicle_make: 'Mercedes', vehicle_model: 'F 015', seats: 4, street_address: '51 Parliament St', city: 'Toronto', province: 'ON', postal_code: 'M5A 2Y5', owner_id: 6)
