...
(1..7).each do |number|
  Availability.create(start_time: 0, end_time: 0, weekday: 'Monday', vehicle_id: number)
  Availability.create(start_time: 0, end_time: 0, weekday: 'Tuesday', vehicle_id: number)
  Availability.create(start_time: 0, end_time: 0, weekday: 'Wednesday', vehicle_id: number)
  Availability.create(start_time: 0, end_time: 0, weekday: 'Thursday', vehicle_id: number)
  Availability.create(start_time: 0, end_time: 0, weekday: 'Friday', vehicle_id: number)
  Availability.create(start_time: 0, end_time: 0, weekday: 'Saturday', vehicle_id: number)
  Availability.create(start_time: 0, end_time: 0, weekday: 'Sunday', vehicle_id: number)
end
